...
public class MenuScreen extends ScreenAdapter implements InputProcessor {
	...
	public MenuScreen() {
		...
		DecoBlock fox = new DecoBlock(new Hitbox(100.0f, 50.0f, 225.0f, 150.0f), "fox-menuScreen.png");
		objects.add(ground);
		objects.add(fox);
	...
	public void render(float delta) {
		...
		display.begin();
		font.draw(display, "Press any key to start the game", Gdx.graphics.getWidth() / 2 - 100.0f, Gdx.graphics.getHeight() / 2);
		display.end();
	}
